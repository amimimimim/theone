...
public abstract class MessageRouter {
	...
	protected List sortByQueueMode(List list) {
		...
		case Q_MODE_RANDOM:
			//System.out.println("Testsend:" + list + ":No:" + count);
			count++;
	...
	boolean ferryflag;
	boolean subferryflag;
	public void setFerryFlag(boolean flag) {
		this.ferryflag = flag;
	}
	public boolean getFerryFlag() {
		return this.ferryflag;
	}

	public void setsubFerryFlag(boolean flag) {
		this.subferryflag = flag;
	}
	public boolean getsubFerryFlag() {
		return this.ferryflag;
	}

	int ferryScore;
	public void setFerryScore(int score) {
		this.ferryScore = score;
	}
	public int getFerryScore() {
		return this.ferryScore;
	}

	int transflag = 0;
	public void setTransFlag(int max_score) {
		this.transflag = max_score;
	}
	...
	Message max_m;
	public void setMax_m(Message max_m) {
		this.max_m = max_m;
	}
	public Message getMax_m() {
		return this.max_m;
	}

	Connection max_con;
	public void setMax_con(Connection max_con) {
		this.max_con = max_con;
	}
	public Connection getMax_con() {
		return this.max_con;
	}

	Tuple<Message, Connection> max_t;
	public void setMax_t(Tuple<Message, Connection> max_t) {
		this.max_t = max_t;
	}
	public Tuple<Message, Connection> getMax_t() {
		return this.max_t;
	}
